            ...
            try
            {
                ...
                if (option == 1)
                {
                    ...
                    currentCinema.WatchMovie(currentCinema.ListOfMovies
                        .FirstOrDefault(x => x.Tittle.ToLower() == chosenMovie.ToLower()));
                }
                else if (option == 2)
                {
                    Console.WriteLine("============================");
                    ...
                    switch (genre.ToLower())
                    {
                        case "comedy":
                            foreach (Movie movie in currentCinema.ListOfMovies)
                            {
                                ...
                                {
                                    Console.WriteLine($"{movie.Tittle} - {movie.Genre}");
                                }
                            }
                            break;
                        case "action":
                        ...
                        case "scifi":
                            ...
                            break;
                        default:
                            throw new Exception("Must be enter correct genre");
                    }

                    Console.WriteLine("============================");
                    Console.WriteLine("Choose movie for watching");
                    string chosenMovie = Console.ReadLine();
                    Console.WriteLine("============================");
                    currentCinema.WatchMovie(currentCinema.ListOfMovies
                        .FirstOrDefault(x => x.Tittle.ToLower() == chosenMovie.ToLower()));
